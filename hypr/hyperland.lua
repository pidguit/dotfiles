...
--
 hl.on("hyprland.start", function () 
    ...
    hl.exec_cmd("env XDG_SESSION_TYPE=wayland discord --start-minimized")
 end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(cba6f7ee)", "rgba(b08cdbee)"}, angle = 45 },
...
hl.curve("easeOutQuint",   { type = "bezier", points = { {0.05, 0.9},    {0.1, 1.05}    } })
